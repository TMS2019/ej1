...
namespace coderush.Pages
{
    public static class MainMenu
    {
        ...
        {
            public const string PageName = "HS";
            public const string RoleName = "HS";
            public const string Path = "/HS/Index";
            public const string ControllerName = "HS";
            public const string ActionName = "Index";
        }

        public static class Dept
        {
            public const string PageName = "Departemen";
            public const string RoleName = "Departemen";
            public const string Path = "/Dept/Index";
            public const string ControllerName = "Dept";
            public const string ActionName = "Index";
        }
